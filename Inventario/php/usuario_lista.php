...
if($total>=1 && $pagina<=$Npaginas){
        ...
        foreach($datos as $rows){
            $tabla.='
                    ...
                    <td>
                        <a href="index.php?vista=user_update&user_id_up='.$rows['usuario_id'].'" class="button is-success is-rounded is-small is-outlined">Actualizar</a>
                    </td>
                    <td>
                        <a href="'.$url.$pagina.'&user_id_del='.$rows['usuario_id'].'" " class="button is-danger  is-rounded is-small is-outlined">Eliminar</a>
                    </td>
                </tr>
